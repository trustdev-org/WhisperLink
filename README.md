...
打开 `http://localhost:3000`，在两个浏览器标签里输入相同邀请码即可对话。
...
| 邀请码泄露 | 仅泄露该房间的群聊解密能力，私聊仍安全（ECDH 在客户端协商） |
...
**Q：邀请码有多安全？**
A：6 位字母数字 ≈ 36⁶ ≈ 22 亿组合。配合 PBKDF2 100000 轮迭代，离线爆破成本较高，但 **不要把邀请码当作高强度密码使用**，建议每次会话用随机邀请码。
